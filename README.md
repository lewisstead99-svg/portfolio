...
- **Scroll-linked flights.** Every hand-over between beats is a blend driven by scroll position, not a
  ...
  into the photograph and sits exactly on the printed tray, rides it out of frame as the plates slide, and flies
  back in for the hall table.
